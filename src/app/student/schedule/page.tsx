...
export default function StudentSchedulePage() {
  ...
  const fetchSchedules = async () => {
    try {
      ...
      const response = await fetch(`/api/student/schedules?${params}`)
        ...
        <CardContent>
          {loading ? (
                    ...
                    <div className="flex-1">
                      ...
                      {event.teacher && (
                        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
                          ...
                          <span>Teacher: {event.teacher.name}</span>
                        </div>
                      )}
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">Your teacher hasn't scheduled any classes or events yet.</p>
            </div>
          )}
        </CardContent>
      </Card>
